...
const Projects = () => {
  const projects = [
    {
      name: 'Project 1',
      description: 'This ia a project i did with bootstrap during my early days in web development.',
      link: 'https://web-development-group2.vercel.app/',
    },
    {
      name: 'Project 2',
      description: 'This ia a project i did with html/css during my early days in web development..',
